...
const koleksiMenuNavigasi = [
    { 
        ...
        target      : '/dashboard',                
        background  : images['edurasa.png']
    },
    { 
        title       : 'Data Siswa',            
        tag         : ['Guru Kelas','admin','Guru Mapel','ptk','Operator Sekolah','Kepala Sekolah'],
        tersedia    : '<span class="text-muted py-2">tersedia</span>',
        icon        : '<i class="bi bi-people-fill"></i>',
        target      : '/data-siswa',
        background  : images['data-siswa.webp']
    },
    { 
        title       :'Absensi Siswa',         
    ...
    { 
        title:'Tabungan',              
        tag:['Guru Kelas','admin','Guru Mapel','ptk',],         tersedia:'<span class="text-muted py-2">tersedia</span>',   icon:'<i class="bi bi-wallet-fill"></i>',               target:'/tabungan',                 background:images['tabungan.webp']},
    { 
        title:'Arsip',                 
        tag:['Guru Kelas','admin','Guru Mapel','ptk','Kepala Sekolah',],         tersedia:'<span class="text-muted py-2">tersedia</span>',   icon:'<i class="bi bi-folder2-open"></i>',              target:'/arsip',                    background:images['arsip.png']},
    { 
        title:'Galeri',                
