export const arsipSuratSidebar = [
    {
        title:'Administrasi Surat',
        menu:[
            {value:'surat_keluar',text:'Surat Keluar',name:'menusidebar'},
            {value:'surat_masuk',text:'Surat Masuk',name:'menusidebar'},
        ]
    },
    {
        title:'Perjalanan Dinas',
        menu:[
            {value:'sppd',text:'SPPD',name:'menusidebar'},
        ]
    },
    {
        title:'Kesiswaan',
