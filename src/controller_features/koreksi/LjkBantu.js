export default class LjkBantu{
    constructor(dataOrmKurtilas,idbarisTabRespon,objCurrentKBM){
    ...
    get objekTabResponSiswa(){
        return this.orm.spreadsheet_array_tabrespon_blangko[0];//.filter(s=>s.idbaris == this.idbarisTabRespon)[0];
    }
    get algoritmaTabRespon(){
        return this.orm.algoritma_by_spreadsheet_tabrespon_blangko[0];//.filter(s=>s.idbaris_respon == this.idbarisTabRespon)[0];
    }
