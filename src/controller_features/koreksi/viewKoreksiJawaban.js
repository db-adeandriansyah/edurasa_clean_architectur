...
const identitasljk = (identitas)=>{
    ...
    html+=`<table class="table table-sm lh-1 table-borderless mt-3 tnr">`;
        ...
        html+=`<tr>`;
            ...
            html+=`<td style="width:15px">:</td>`;
            html+=`<td>${identitas.waktustart_siswa}</td>`;
        ...
        html+=`<tr>`;
            ...
            html+=`<td style="width:15px">:</td>`;
            html+=`<td>${identitas.waktuakhir_siswa}</td>`;
            html+=`<td class="text-nowrap">Kompetensi yang diukur</td>`;
            html+=`<td style="width:15px">:</td>`;
            html+=`<td>`;
...
const soalDanJawabanIsianSiswa = (n,data,mode)=>{
    ...
    if(mode){
        html+=`<div id="untuklj${n.nosoal}" class="koleksilj d-none" style="border:1px solid red;padding:5px;background-color:#eeeeff" data-refrensinilai="${n.nosoal}">${nilai}</div>`
    }else{
