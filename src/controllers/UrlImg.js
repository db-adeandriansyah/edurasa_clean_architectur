export default class UrlImg{
    ...
    constructor(x){;;
        ...
        //https://drive.google.com/uc?export=view&amp;id=https://lh3.googleusercontent.com/d/1qcpzq9ABBR8WVMXOk38AEiKN8KRj6YH-
        this.#latex = `https://latex.codecogs.com/png.latex?%5Cdpi%7B0%7D%20%5Cbg_white%20%7B`;
                     //https://latex.codecogs.com/png.latex?%5Cdpi%7B0%7D%20%5Cbg_white%20%7B   
    ...
    static replacingImg(string){
        ...
        let nstring = new String(string).replaceAll('https://chart.apis.google.com/chart?cht=tx&chl=%7B','https://chart.apis.google.com/chart?cht=tx&chl=%7B');
        nstring = nstring.replaceAll('https://chart.apis.google.com/chart?cht=tx&amp;chl=%7B','https://chart.apis.google.com/chart?cht=tx&chl=%7B');
