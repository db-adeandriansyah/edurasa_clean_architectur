...
const AbsensiFitur= await import( "../controller_features/absensi/AbsensiFitur").then(module=>  module.default  );;
const KaldikFitur = await import("../controller_features/kaldik/KaldikFitur").then(module=>  module.default  );;
